...
public class TodoService {
    ...
    static {
        ...
        todoItems.add(new TodoItem(3, "charlie", "Schedule dentist appointment", LocalDate.of(2024, 11, 15), false));
        todoItems.add(new TodoItem(4, "dave", "Prepare for presentation", LocalDate.of(2024, 11, 12), true));
        todoItems.add(new TodoItem(5, "eve", "Finish reading book", LocalDate.of(2024, 11, 20), false));
        todoItems.add(new TodoItem(6, "frank", "Renew gym membership", LocalDate.of(2024, 11, 25), false));
        todoItems.add(new TodoItem(7, "grace", "Submit tax documents", LocalDate.of(2024, 12, 1), false));
        todoItems.add(new TodoItem(8, "heidi", "Clean the garage", LocalDate.of(2024, 11, 22), true));
